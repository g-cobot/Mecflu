...
#define M 0.5                   // MASSA DO PISTAO [Kg]
#define A1 10.771064914              // AREA DA SESSAO TRANSVERSAL DO CILINDRO [m²]
#define A 0.1256              // AREA DA SESSAO TRANSVERSAL DO CILINDRO [m²]
#define g 9.8107000000          // ACELERACAO GRAVITACIONAL [m/s²]
#define T 293.15
#define R 287.0530
#define mi 17.2*0.000001
#define Zi 8.571341116
...
//SUBROTINAS
//-----------------------------------------------
#include</home/gabriel/Desktop/MecFlu/mod3/subrotinas/pression.c>
#include</home/gabriel/Desktop/MecFlu/mod3/subrotinas/force.c>
#include</home/gabriel/Desktop/MecFlu/mod3/subrotinas/position.c>
#include</home/gabriel/Desktop/MecFlu/mod3/subrotinas/speed.c>
#include</home/gabriel/Desktop/MecFlu/mod3/subrotinas/especific_mass.c>
#include</home/gabriel/Desktop/MecFlu/mod3/subrotinas/volume.c>
#include</home/gabriel/Desktop/MecFlu/mod3/subrotinas/graphic.c>
//-----------------------------------------------
//PROGRAMA PRINCIPAL
//-----------------------------------------------
int main (void){
...
//-----------------------------------------------
  ...
  printf("z=%4.3f v=%4.3f rho=%4.3f vol=%4.3f p=%4.3f f=%4.3f tempo= %4.4f s \n",zn,vn,rhon,voln,pn,fn,t);
  }
return 0;
}
